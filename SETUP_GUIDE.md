...
AIOPS_AUTO_RETRAIN_PERIOD_MONTHS=3
AIOPS_AUTO_RETRAIN_COOLDOWN_MINUTES=360
AIOPS_FAILURE_RMSE_THRESHOLD=0.35
AIOPS_FAILURE_RMSE_DEGRADATION_RATIO=1.15
PREDICTION_MAX_VALID_RMSE=0.35
```
